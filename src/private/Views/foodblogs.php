...
<!-- finding blog details of category food limit set to 5  -->
<?php
echo "<h3 class='text-center mt-4'>Top 5 Food  Blogs</h3>";
$blog1 = Blog ::find('all', array('conditions' => 'category =  "food" LIMIT 5'));
